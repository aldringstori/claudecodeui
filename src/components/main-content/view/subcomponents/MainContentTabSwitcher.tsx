import { LayoutDashboard, Columns2, MessageSquare, Terminal, Folder, GitBranch, ClipboardCheck, type LucideIcon } from 'lucide-react';
...
const BASE_TABS: TabDefinition[] = [
  ...
  { id: 'multichat', labelKey: 'tabs.multichat', icon: Columns2 },
